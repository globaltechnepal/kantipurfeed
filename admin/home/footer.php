...
// add product into database through api
// add product into database through api
...
//  This code is commented by bikesh 
//  This code is commented by bikesh 
...
//     var addProduct_code = $("#addProduct_code").val();
...
//     if (catID == "" || addCategory_name == "" || addProduct_name == "" || addActual_Price == "" || addSell_Price == "" || addPrimary_image == "" || addSecondary_image == ""||wholesale_Price==""||dealer_Price==""||retailer_Price==""||addProduct_code==""||specification=="") {
...
//         url: "library/database.php",
//         method: "POST",
//         data: { catID: catID, addProduct_name: addProduct_name, addSell_Price: addSell_Price, addActual_Price: addActual_Price, addPrimary_image: addPrimary_image, addSecondary_image: addSecondary_image,wholesale_Price:wholesale_Price,addProduct_code:addProduct_code,specification:specification,dealer_Price:dealer_Price,retailer_Price:retailer_Price },
//         success: function (data) {
...
$(".close_called").on('click',function(){
    ...
    // submit new color is here from page colorpeaker.php
        ...
        //     var category_image = $("#category_image").val().replace(/C:\\fakepath\\/i, '');
        //     if (category_id == "" || category_name == "" || category_type == ""||category_image=="") {
        ...
        //             url: "library/database.php",
        //             method: "POST",
        //             data: { category_name: category_name, category_id: category_id, category_type: category_type,category_image:category_image },
        //             datatype: "JSON",
        //             success: function (data) {
...
// ADD Order API Integration Code
        ...
        $('#updateCategorySubmit').click(function () {
            ...
            var cat_image_update = $("#cat_image_update").val().replace(/C:\\fakepath\\/i, '');
            if (updatecategoryname == "" || updatecategorytype == "") {
                ...
                $.ajax({
                    url: "../library/database.php",
                    method: "POST",
                    data: { updatecategoryname: updatecategoryname, update_category_id: update_category_id, updatecategorytype: updatecategorytype,cat_image_update:cat_image_update },
                    success: function (data) {
