        ...
        <td colspan="3">
         <table class="table">
              <thead>
                ...
                <tbody>
                    <?php 
                         $query = "SELECT  `vendor_checkout_items`.`id`,`category_name`,`product_code`,`product_name`, `vendor_checkout_id`,`product_id`, `order_quantity`,`img_path`, `primary_image`, `sales_rate`, `discountAmount`,`total_after_discount`, `total_amt` FROM `vendor_checkout_items`
