...
// $sql = "SELECT id,product_name,actual_price,sell_price,img_path,primary_image,secondary_image,url_link FROM products";
  $sql = "SELECT id,product_name,LEFT(product_name,16)as trunkName,ROUND(actual_price,0) as actual_price,ROUND(sell_price,0)as sell_price,img_path,primary_image,secondary_image FROM products where `product_name`= '$getproductName' ";
//   echo $sql;
  $conn = connectdb();
...
//product card layout 
  ...
  <div id="products" class="font-normal mb-2 col-sm-5 product-wrapper product-card-size text-start"
    style="background-color:#e3e3e3; margin-top:10px; margin-right:10px;">
